...
- `uninstall.sh` — Companion uninstall script that removes the installed command, related installation artifacts, and the `~/.termstory` data directory. Use `--yes` to skip the confirmation prompt.
